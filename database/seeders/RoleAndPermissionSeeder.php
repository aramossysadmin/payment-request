...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    private const ROLE_PERMISSIONS = [
        'super_admin' => [
            ...
            'view_any_investment::request', 'view_investment::request', 'create_investment::request', 'update_investment::request',
            'delete_investment::request', 'delete_any_investment::request', 'restore_investment::request', 'restore_any_investment::request',
            'replicate_investment::request', 'reorder_investment::request', 'force_delete_investment::request', 'force_delete_any_investment::request',
