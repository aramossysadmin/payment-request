...
it('can create a payment request with invoice payment type', function () {
    ...
    $branch = Branch::factory()->create();
    $expenseConcept = ExpenseConcept::factory()->create();
    $paymentType = PaymentType::factory()->create(['invoice_documents_mode' => 'required', 'additional_documents_mode' => 'optional']);
...
it('can create a payment request with advance payment type', function () {
    ...
    $branch = Branch::factory()->create();
    $expenseConcept = ExpenseConcept::factory()->create();
    $paymentType = PaymentType::factory()->create(['invoice_documents_mode' => 'disabled', 'additional_documents_mode' => 'optional']);
...
it('can edit payment type on a payment request', function () {
    $invoiceType = PaymentType::factory()->create(['invoice_documents_mode' => 'required', 'additional_documents_mode' => 'optional']);
    $advanceType = PaymentType::factory()->create(['invoice_documents_mode' => 'disabled', 'additional_documents_mode' => 'optional']);
    $paymentRequest = PaymentRequest::factory()->create([
...
it('authorizer can see payment requests with assigned approvals from other departments', function () {
    ...
    $adminDept->update(['authorizer_level_1_id' => $adminAuthorizer->id]);
