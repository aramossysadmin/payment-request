...
class UpdateInvestmentRequestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'advance_documents' => ['nullable', 'array', 'max:5'],
            'advance_documents.*' => ['file', 'max:10240', 'mimes:pdf,jpg,jpeg,png'],
    ...
    public function messages(): array
    {
        return [
            ...
            'advance_documents.max' => 'No se permiten más de 5 documentos.',
            'advance_documents.*.max' => 'Cada documento no debe superar los 10MB.',
            'advance_documents.*.mimes' => 'Los documentos deben ser PDF o imagen (JPG, JPEG o PNG).',
