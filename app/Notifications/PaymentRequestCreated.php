...
class PaymentRequestCreated extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Nueva Solicitud de Pago #'.$this->paymentRequest->id)
    ...
    public function toDatabase(User $notifiable): array
    {
        return FilamentNotification::make()
            ...
            ->body('Solicitud #'.$this->paymentRequest->id.' de '.$this->paymentRequest->user->name.' por $'.number_format($this->paymentRequest->total, 2))
