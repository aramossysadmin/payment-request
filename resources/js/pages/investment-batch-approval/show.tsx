...
export default function BatchApprovalShow({ batch }: Props) {
    ...
    const handleSubmit = () => {
        setSubmitting(true);
        router.post(
            `/investment-batch-approval/${batch.token}/review`,
            {
    ...
    return (
        <>
            <Head title={`Aprobar lote de pagos — ${batch.department}`} />
                ...
                <div className="mx-auto max-w-4xl space-y-6">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Revisa los pagos del lote y marca los que apruebas. Los que dejes sin marcar serán rechazados.
                        </p>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Pagos del Lote</CardTitle>
                        </CardHeader>
                        <CardContent>
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-gray-50 dark:bg-gray-800">
                                        <tr className="border-b-2 border-gray-200 text-left text-gray-600 dark:border-gray-700 dark:text-gray-300">
                                            ...
                                            <th className="px-4 py-3 font-semibold whitespace-nowrap text-right">Monto</th>
                                        </tr>
                                    </thead>
