                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                sesión, el cual puedes obtener de la aplicación compatible
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                pedirá un pin seguro durante el inicio de sesión. Este pin
                                se puede obtener de una aplicación compatible con TOTP en
                                tu teléfono.
                            </p>
