...
export default function Edit() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Editar',
            href: `/investment-requests/${pr.uuid}/edit`,
        },
    ];
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.post(`/investment-requests/${pr.uuid}`, formData, {
            forceFormData: true,
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3">
                        <Button
                            ...
                            variant="outline"
                            onClick={() =>
                                router.visit(`/investment-requests/${pr.uuid}`)
                            }
                        >
                            Cancelar
                        </Button>
