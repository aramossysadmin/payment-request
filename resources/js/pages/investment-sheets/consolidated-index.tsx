...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Consolidado', href: '/investment-sheets/consolidated' },
];
...
export default function ConsolidatedIndex() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Consolidado de Inversión" />
            ...
            <div className="p-4 md:p-6 space-y-6">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Selecciona un proyecto para ver el detalle consolidado de sus hojas de inversión.
                    </p>
                </div>
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <p className="text-lg font-medium text-gray-500 dark:text-gray-400">
                                No hay proyectos con hojas de inversión
                            </p>
                            <p className="mt-1 text-sm text-gray-400 dark:text-gray-500">
                                Las hojas de inversión aparecerán aquí cuando se creen y asocien a un proyecto.
                            </p>
                        </CardContent>
                    </Card>
                ) : (
                                ...
                                <CardContent className="pt-6">
                                    ...
                                    <div className="mt-4 flex items-center justify-between border-t pt-4">
                                        <div className="flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            {project.sheets_count} {project.sheets_count === 1 ? 'hoja' : 'hojas'}
                                        </div>
